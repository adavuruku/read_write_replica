 ...
 **/
public class EntitledEvent implements ExportedEvent {
    ...
    public EntitledEvent(long id, String payload) {
        this.id = id;
        this.payload = payload;
        this.timestamp = Instant.now();
    }

    public static EntitledEvent of(
        ...
        return new EntitledEvent(id, jsonString);
    }
